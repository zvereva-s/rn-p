...
11. ✅ Фильтрация постов на ProfileScreen

=================================================================================================

✅ загрузка аватарки в Регистрации (выбор с файлов или сделать фото)
...
<img src='https://github.com/zvereva-s/rn-p/raw/main/images/deploy.jpg' width='500' heigth='auto'/>
<br>
